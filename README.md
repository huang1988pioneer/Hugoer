...
.\scripts\publish.ps1
# 或指定版本
.\scripts\publish.ps1 -Version 1.5.2
# 只要單一 exe、不要安裝程式
...
vpk pack --packId Hugoer --packVersion 1.5.2 --packDir .\dist\publish\win-x64 --mainExe Hugoer.exe --outputDir .\dist\releases\velopack
```
